...
public class Arm_RunToMediumNode extends CommandBase {
  /** Creates a new Arm_RunToHighNode. */
  private ArmSubsystem armSubsystem;
  private IntakeSubsystem intakeSubsystem;
  public Arm_RunToMediumNode(ArmSubsystem armSubsystem, IntakeSubsystem intakeSubsystem) {
