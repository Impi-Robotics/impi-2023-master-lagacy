...
public class ArmSubsystem extends SubsystemBase {
  ...
  public ArmSubsystem() {
    ...
    rightArmMotor.setSmartCurrentLimit(Constants.SMART_LIMITS.ARM_SMART_LIMIT);
    leftArmMotor.setSmartCurrentLimit(Constants.SMART_LIMITS.ARM_SMART_LIMIT);
  ...
  public void periodic() {
    ...
    // arm pos encoder
    shuffleboardArmEncoder.setDouble(armEncoder.getPosition());
    // arm pos setpoint
  ...
  public boolean isGamePieceGrabbed() {
    return getFlipSensor() && getGrabberClosed();
  }
